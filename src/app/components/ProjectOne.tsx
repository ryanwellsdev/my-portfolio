    ...
    <div className="relative h-full flex items-center">
      ...
      <div
        className={`h-full bg-white z-20 transition-all duration-500 ease-in-out ${
          isOpen ? "w-[calc(50vw-4rem)] border-l-2 border-black" : "w-0"
        }`}
        style={{ overflow: "hidden", boxSizing: "border-box" }}
      >
        {/* Content Div */}
        <div
          className={`h-full pl-36 flex flex-col justify-center items-center text-center p-4 transition-opacity duration-500 ease-in-out ${
