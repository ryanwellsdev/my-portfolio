...
const ProjectOne: React.FC<ProjectProps> = ({
  ...
  return (
    ...
    >
      {/* Toggle Button */}
      <div
        className={`relative flex items-center justify-center transition-transform duration-500 toggle-button-hover bg-white z-30 cursor-pointer border-r-2 border-black ${
