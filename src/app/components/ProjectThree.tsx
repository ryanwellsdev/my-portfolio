...
const ProjectThree: React.FC<ProjectProps> = ({
  ...
  return (
    <div
      className="relative h-full flex items-center project-container" // Added project-container class
    ...
    >
      ...
      >
        <div className="relative overflow-hidden w-full h-full flex items-center gradient-overlay justify-center">
          <span
            className="text-black text-base animate-vertical-marquee rotate-90" // Added animate-vertical-marquee and rotate-90 classes
