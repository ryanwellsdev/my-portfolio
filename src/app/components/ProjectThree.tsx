...
const ProjectTwo: React.FC<ProjectProps> = ({
  ...
  return (
    ...
    >
      {/* Toggle Button */}
      <div
        className={`flex items-center justify-center transition-transform duration-500 bg-[#f8f8f8] z-30 cursor-pointer border-r-2 border-l-2 border-black hover:bg-[#ADFF2F] ${
